...
| `homepage-custom-content.html` | Customize > Homepage > Homepage content > Custom content *(legacy field — only some older KBs use it; not the same as `custom-html-5-homepage.html`)* |
