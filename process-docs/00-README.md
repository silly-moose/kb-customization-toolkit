...
| `theme-templates/` | Reusable, brand-swappable theme templates (each a subfolder) + how to apply one in a build and how to build new ones. Start at `theme-templates/README.md`. |
